...
% Copyright (C) 2021-2022, 2025 The Mercury team.
%---------------------------------------------------------------------------%
%
% File: curs.m
%
...
// However, it is essential that these pointers be visible
// to the garbage collector, otherwise it will think that the closures
// are unreferenced and reuse the storage. Hence we redefine malloc()
// and friends to call GC_malloc().
