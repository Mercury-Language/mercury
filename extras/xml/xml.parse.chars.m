...
base_char -->
    ...
    or (0x01FA-0x0217) or (0x0250-0x02A8) or (0x02BB-0x02C1) or mchr(0x0386)
    or (0x0388-0x038A) or mchr(0x038C) or (0x038E-0x03A1) or (0x03A3-0x03CE)
    or (0x03D0-0x03D6) or mchr(0x03DA) or mchr(0x03DC) or mchr(0x03DE)
    or mchr(0x03E0)
    ...
    or (0x04EE-0x04F5) or (0x04F8-0x04F9) or (0x0531-0x0556) or mchr(0x0559)
    or (0x0561-0x0586) or (0x05D0-0x05EA) or (0x05F0-0x05F2)
    or (0x0621-0x063A) or (0x0641-0x064A) or (0x0671-0x06B7)
    or (0x06BA-0x06BE) or (0x06C0-0x06CE) or (0x06D0-0x06D3) or mchr(0x06D5)
    or (0x06E5-0x06E6) or (0x0905-0x0939) or mchr(0x093D) or (0x0958-0x0961)
    or (0x0985-0x098C) or (0x098F-0x0990) or (0x0993-0x09A8)
    or (0x09AA-0x09B0) or mchr(0x09B2) or (0x09B6-0x09B9) or (0x09DC-0x09DD)
    ...
    or (0x0A59-0x0A5C) or mchr(0x0A5E) or (0x0A72-0x0A74) or (0x0A85-0x0A8B)
    or mchr(0x0A8D) or (0x0A8F-0x0A91) or (0x0A93-0x0AA8) or (0x0AAA-0x0AB0)
    or (0x0AB2-0x0AB3) or (0x0AB5-0x0AB9) or mchr(0x0ABD) or mchr(0x0AE0)
    or (0x0B05-0x0B0C) or (0x0B0F-0x0B10) or (0x0B13-0x0B28)
    or (0x0B2A-0x0B30) or (0x0B32-0x0B33) or (0x0B36-0x0B39) or mchr(0x0B3D)
    or (0x0B5C-0x0B5D) or (0x0B5F-0x0B61) or (0x0B85-0x0B8A)
    or (0x0B8E-0x0B90) or (0x0B92-0x0B95) or (0x0B99-0x0B9A) or mchr(0x0B9C)
    ...
    or (0x0CB5-0x0CB9) or mchr(0x0CDE) or (0x0CE0-0x0CE1) or (0x0D05-0x0D0C)
    or (0x0D0E-0x0D10) or (0x0D12-0x0D28) or (0x0D2A-0x0D39)
    or (0x0D60-0x0D61) or (0x0E01-0x0E2E) or mchr(0x0E30) or (0x0E32-0x0E33)
    or (0x0E40-0x0E45) or (0x0E81-0x0E82) or mchr(0x0E84) or (0x0E87-0x0E88)
    or mchr(0x0E8A) or mchr(0x0E8D) or (0x0E94-0x0E97) or (0x0E99-0x0E9F)
    or (0x0EA1-0x0EA3) or mchr(0x0EA5) or mchr(0x0EA7) or (0x0EAA-0x0EAB)
    or (0x0EAD-0x0EAE) or mchr(0x0EB0) or (0x0EB2-0x0EB3) or mchr(0x0EBD)
    or (0x0EC0-0x0EC4) or (0x0F40-0x0F47) or (0x0F49-0x0F69)
    or (0x10A0-0x10C5) or (0x10D0-0x10F6) or mchr(0x1100) or (0x1102-0x1103)
    or (0x1105-0x1107) or mchr(0x1109) or (0x110B-0x110C) or (0x110E-0x1112)
    or mchr(0x113C) or mchr(0x113E) or mchr(0x1140) or mchr(0x114C)
    or mchr(0x114E) or mchr(0x1150)
    or (0x1154-0x1155) or mchr(0x1159) or (0x115F-0x1161) or mchr(0x1163)
    or mchr(0x1165)
    or mchr(0x1167) or mchr(0x1169) or (0x116D-0x116E) or (0x1172-0x1173)
    or mchr(0x1175)
    or mchr(0x119E) or mchr(0x11A8) or mchr(0x11AB) or (0x11AE-0x11AF)
    or (0x11B7-0x11B8)
    or mchr(0x11BA) or (0x11BC-0x11C2) or mchr(0x11EB) or mchr(0x11F0)
    or mchr(0x11F9)
    or (0x1E00-0x1E9B) or (0x1EA0-0x1EF9) or (0x1F00-0x1F15)
    or (0x1F18-0x1F1D) or (0x1F20-0x1F45) or (0x1F48-0x1F4D)
    or (0x1F50-0x1F57) or mchr(0x1F59) or mchr(0x1F5B) or mchr(0x1F5D)
    or (0x1F5F-0x1F7D)
    or (0x1F80-0x1FB4) or (0x1FB6-0x1FBC) or mchr(0x1FBE) or (0x1FC2-0x1FC4)
    or (0x1FC6-0x1FCC) or (0x1FD0-0x1FD3) or (0x1FD6-0x1FDB)
    or (0x1FE0-0x1FEC) or (0x1FF2-0x1FF4) or (0x1FF6-0x1FFC) or mchr(0x2126)
    or (0x212A-0x212B) or mchr(0x212E) or (0x2180-0x2182) or (0x3041-0x3094)
...
ideographic -->
    return(nil),
    (0x4E00-0x9FA5) or mchr(0x3007) or (0x3021-0x3029).
...
combining_char -->
    ...
    or (0x05BB-0x05BD) or mchr(0x05BF) or (0x05C1-0x05C2) or mchr(0x05C4)
    or (0x064B-0x0652) or mchr(0x0670) or (0x06D6-0x06DC) or (0x06DD-0x06DF)
    or (0x06E0-0x06E4) or (0x06E7-0x06E8) or (0x06EA-0x06ED)
    or (0x0901-0x0903) or mchr(0x093C) or (0x093E-0x094C) or mchr(0x094D)
    or (0x0951-0x0954) or (0x0962-0x0963) or (0x0981-0x0983) or mchr(0x09BC)
    or mchr(0x09BE) or mchr(0x09BF) or (0x09C0-0x09C4) or (0x09C7-0x09C8)
    or (0x09CB-0x09CD) or mchr(0x09D7) or (0x09E2-0x09E3) or mchr(0x0A02)
    or mchr(0x0A3C)
    or mchr(0x0A3E) or mchr(0x0A3F) or (0x0A40-0x0A42) or (0x0A47-0x0A48)
    or (0x0A4B-0x0A4D) or (0x0A70-0x0A71) or (0x0A81-0x0A83) or mchr(0x0ABC)
    or (0x0ABE-0x0AC5) or (0x0AC7-0x0AC9) or (0x0ACB-0x0ACD)
    or (0x0B01-0x0B03) or mchr(0x0B3C) or (0x0B3E-0x0B43) or (0x0B47-0x0B48)
    or (0x0B4B-0x0B4D) or (0x0B56-0x0B57) or (0x0B82-0x0B83)
    or (0x0BBE-0x0BC2) or (0x0BC6-0x0BC8) or (0x0BCA-0x0BCD) or mchr(0x0BD7)
    ...
    or (0x0D46-0x0D48) or (0x0D4A-0x0D4D) or mchr(0x0D57) or mchr(0x0E31)
    or (0x0E34-0x0E3A) or (0x0E47-0x0E4E) or mchr(0x0EB1) or (0x0EB4-0x0EB9)
    or (0x0EBB-0x0EBC) or (0x0EC8-0x0ECD) or (0x0F18-0x0F19) or mchr(0x0F35)
    or mchr(0x0F37) or mchr(0x0F39) or mchr(0x0F3E) or mchr(0x0F3F)
    or (0x0F71-0x0F84)
    or (0x0F86-0x0F8B) or (0x0F90-0x0F95) or mchr(0x0F97) or (0x0F99-0x0FAD)
    or (0x0FB1-0x0FB7) or mchr(0x0FB9) or (0x20D0-0x20DC) or mchr(0x20E1)
    or (0x302A-0x302F) or mchr(0x3099) or mchr(0x309A).
...
extender -->
    return(nil),
    mchr(0x00b7) or mchr(0x02d0) or mchr(0x02d1) or mchr(0x0387)
    or mchr(0x0640) or mchr(0x0e46)
    or mchr(0x0ec6) or mchr(0x3005) or (0x3031-0x3035) or (0x309d-0x309e)
    or (0x30fc-0x30fe).
