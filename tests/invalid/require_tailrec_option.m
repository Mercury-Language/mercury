...
%
% This is mostly a copy of require_tailrec_pragma.m. Whereas that test case
% contains pragmas that positively request warnings or errors, this test case
% is compiled with --warn-non-tail-recursion self-and-mutual, and uses pragmas
% either to disable warnings, or to turn them into errors.
%
%---------------------------------------------------------------------------%

:- module require_tailrec_option.
...
%---------------------------------------------------------------------------%
    ...
    % WAS: Self non-tail recursion with self_recursion_only pragma.
    %
...
map1(P, [X | Xs], [Y | Ys]) :-
    ...
    % WAS: Self non-tail recursion with self_or_mutual_recursion pragma.
    %
