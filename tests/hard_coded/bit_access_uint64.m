...
:- pred run_modify_test((func(uint64, uint) = uint64)::in,
...
:- pred run_modify_on_input((func(uint64, uint) = uint64)::in,
...
:- pred run_modify_on_input_at_index((func(uint64, uint) = uint64)::in,
...
:- pred run_value_on_input_at_index(
    pred(uint64, uint)::in(pred(in, in) is semidet),
    string::in, uint64::in, uint::in, io::di, io::uo) is cc_multi.
