...
:- pred run_modify_on_input((func(uint32, uint) = uint32)::in, string::in,
...
:- pred run_modify_on_input_at_index((func(uint32, uint) = uint32)::in, string::in,
...
:- pred run_value_on_input_at_index(pred(uint32, uint)::in(pred(in, in) is semidet),
