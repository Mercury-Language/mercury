...
#include \"mercury_std.h\"             // For MR_TRUE, MR_FALSE, MR_YES, MR_NO.
...
// When succeeded is MR_YES, returns a handle through which the system
// RNG can be accessed; err_msg will point to the empty string in this case.
// When succeeded is MR_NO, the value returned is not a valid handle and
...
// Returns MR_YES on success with err_msg pointing to the empty string.
// Returns MR_NO on failure with err_msg pointing to a string (on the
...
// Returns MR_YES if len bytes were generated; err_msg will point to the empty
// string.
// Returns MR_NO if the system RNG has been unable to generate len bytes.
