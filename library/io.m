...
% a programmer's chosen method would agree with the one used by a system-supplied
% predicate for reading in e.g. floats, if this module had one.
...
%---------------------------------------------------------------------------%
%
% Output predicates (with output to the specifed binary stream).
%
