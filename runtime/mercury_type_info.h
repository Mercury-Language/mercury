...
#define MR_COMMA ,
  ...
  #define MR_IF_SOLVE_EQUAL(x) x
  #define MR_IF_SOLVE_EQUAL_ELSE(x,y) x
#else
  #define MR_IF_SOLVE_EQUAL(x) 
  #define MR_IF_SOLVE_EQUAL_ELSE(x,y) y
#endif
#ifdef MR_USE_INIT
  #define MR_IF_INIT(x) x
  #define MR_IF_INIT_ELSE(x,y) x
#else
  #define MR_IF_INIT(x) 
  #define MR_IF_INIT_ELSE(x,y) y
#endif
/*---------------------------------------------------------------------------*/
