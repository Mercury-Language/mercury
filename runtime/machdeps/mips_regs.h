...
reg 	Word	mr0 __asm("s0");
reg	Word	mr1 __asm("s1");
reg	Word	mr2 __asm("s2");
reg	Word	mr3 __asm("s3");
reg	Word	mr4 __asm("s4");
reg	Word	mr5 __asm("s5");
reg	Word	mr6 __asm("s6");
reg	Word	mr7 __asm("s7");
