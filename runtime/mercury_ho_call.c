...
** input.
**
** XXX This code should and mercury__init_1_0 below should use
** mercury_unify_compare_body.h too
*/
...
Define_entry(mercury__solve_equal_2_0);
{
	...
	tailcall(type_ctor_info->solve_equal_pred, 
		LABEL(mercury__solve_equal_2_0));
}
...
Define_entry(mercury__init_1_0);
{
	...
	tailcall(type_ctor_info->init_pred, LABEL(mercury__init_1_0));
}
