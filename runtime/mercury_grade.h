...
/*
** In order to reduce conflicts whenever somebody else adds a grade
** component, the following HAL-specific components (rt, se) deviate
** from the standard naming conventions.
*/

#ifdef MR_RESERVE_TAG
  #define MR_GRADE_PART_HAL_1	MR_PASTE2(MR_GRADE_PART_6, _rt)
#else
  #define MR_GRADE_PART_HAL_1	MR_GRADE_PART_6
#endif

#ifdef MR_USE_SOLVE_EQUAL
  #define MR_GRADE_PART_HAL_2	MR_PASTE2(MR_GRADE_PART_HAL_1, _se)
#else
  #define MR_GRADE_PART_HAL_2	MR_GRADE_PART_HAL_1
#endif

#ifdef MR_USE_MINIMAL_MODEL
  #define MR_GRADE_PART_7	MR_PASTE2(MR_GRADE_PART_HAL_2, _mm)
#else
  #define MR_GRADE_PART_7	MR_GRADE_PART_HAL_2
#endif
