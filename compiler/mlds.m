...
% may just be a generic type such as `MR_Word' or `MR_Box').
%
% 7. Data constructors.
%
...
%
% XXX The discussion about type classes above looks to be quite out-of-date.
%
%---------------------------------------------------------------------------%
%
...
%
% That means that to support liveness-accurate GC the HLDS->MLDS code
...
:- type mlds_enum_class_defn
    --->    mlds_enum_class_defn(
                ...
                %
                % There is a value field in java/runtime/MercuryEnum.java,
...
:- type mlds_type
    ...
    ;       mlds_mercury_array_type(mlds_type)
            ...
            % will treat it like any other mercury_type, whereas others may
...
:- type mlds_atomic_statement
    ...
    ;       outline_foreign_proc(
                ...
                % and calling it. The lvals are used to generate the
                % appropriate forwarding code.
...
:- type mlds_local_var_name
    ...
    ;       lvn_tscc_output_var_succeeded
            ...
            %
            % lvn_tscc_output_var(ArgNum, VarName) represents one of the output
            % arguments of a TSCC (tail-call SCC); the ArgNum says which.
