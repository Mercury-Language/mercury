...
:- type ext_cur
    ...
    ;       ext_cur_user_order                  % ".module_order"
    ;       ext_cur_user_order_to               % ".module_order_for_trans_opt"
...
ext_cur_extension(Ext, Str) :-
    ...
    ; Ext = ext_cur_user_order,               Str = ".module_order"
    ; Ext = ext_cur_user_order_to,          Str = ".module_order_for_trans_opt"
