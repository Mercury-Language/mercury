...
:- pred separate_items_in_aug_comp_unit(aug_compilation_unit::in,
    ...
    ims_list(item_abstract_instance_info)::out,
...
:- type item_accumulator
    --->    item_accumulator(
                ...
                ia_int_instances    :: ims_cord(item_abstract_instance_info),
                ia_imp_instances    :: ims_cord(item_instance_info),
...
separate_items_in_aug_comp_unit(AugCompUnit, InclMap, Avails, FIMs,
        ...
        DeclPragmasTypeSpecConstr, DeclPragmasTypeSpec, DeclPragmasInputSpec,
    ...
    some [!Acc] (
        !:Acc = item_accumulator(cord.init, cord.init,
            ...
            cord.init, cord.init, cord.init, cord.init, cord.init,
            cord.init, cord.init,
        ...
        !.Acc = item_accumulator(AvailsCord, FIMsCord,
            ...
            InstDefnsCord, ModeDefnsCord,
            TypeClassesCord, IntInstancesCord, ImpInstancesCord,
    ...
    DeclPragmasInputSpec = cord.list(DeclPragmasInputSpecCord),
...
acc_parse_tree_module_src(ParseTreeModuleSrc, !Acc) :-
    ...
    !.Acc = item_accumulator(AccAvails0, AccFIMs0,
        ...
        AccInstDefns0, AccModeDefns0,
        AccTypeClasses0, AccIntInstances0, AccImpInstances0,
    ...
    acc_ims_list(IntItemMercuryStatus, IntInstances,
        AccIntInstances0, AccIntInstances),
    acc_ims_list(SubItemMercuryStatus, SubInstances,
        AccImpInstances0, AccImpInstances),
    ...
    !:Acc = item_accumulator(AccAvails, AccFIMs,
        ...
        AccInstDefns, AccModeDefns,
        AccTypeClasses, AccIntInstances, AccImpInstances,
...
acc_parse_tree_int1(ParseTreeInt1, ReadWhy1, !Acc) :-
    ...
    !:Acc = item_accumulator(AccAvails, AccFIMs,
        AccTypeDefnsAbs, AccTypeDefnsMer, AccTypeDefnsFor,
        AccInstDefns, AccModeDefns,
        AccTypeClasses, AccIntInstances, AccImpInstances0,
        AccPredDecls, AccModeDecls, AccClauses0, AccForeignProcs0,
        AccForeignEnums, AccForeignExportEnums0,
        AccDeclPragmas, AccDeclMarkers,
        AccDeclPragmasTypeSpecConstr0, AccDeclPragmasTypeSpec0,
...
acc_parse_tree_plain_opt(ParseTreePlainOpt, !Acc) :-
    ...
    acc_ims_list(ItemMercuryStatus, Instances,
        AccImpInstances0, AccImpInstances),
    ...
    acc_ims_list(ItemMercuryStatus, InputSpecs,
        AccDeclPragmasInputSpec0, AccDeclPragmasInputSpec),
