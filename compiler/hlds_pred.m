...
:- pred proc_prepare_to_clone(proc_info::in, list(prog_var)::out,
    ...
    map(prog_var, string)::out, list(diag_spec)::out, set(pred_proc_id)::out,
...
:- pred proc_create(list(prog_var)::in,
    ...
    map(prog_var, string)::in, list(diag_spec)::in, set(pred_proc_id)::in,
...
:- pred proc_info_set_var_name_remap(map(prog_var, string)::in,
    proc_info::in, proc_info::out) is det.
:- pred proc_info_set_statevar_warnings(list(diag_spec)::in,
    proc_info::in, proc_info::out) is det.
...
:- type proc_sub_info
    --->    proc_sub_info(
                ...
                psi_statevar_warnings           :: list(diag_spec),
