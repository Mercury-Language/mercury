...
augment_and_process_source_file(ProgressStream, ErrorStream, Globals,
    ...
    parse_tree_src_to_burdened_module_list(Globals, SourceFileName,
        ...
        SplitErrSpecs, SplitWarnSpecs, BurdenedModules0),
    add_to_be_written_err_specs(SplitErrSpecs, !MaybeWrittenSpecs),
    add_to_be_written_warn_specs(SplitWarnSpecs, !MaybeWrittenSpecs),
    (
...
augment_and_process_module(ProgressStream, ErrorStream, Globals,
    ...
    check_module_interface_for_no_exports(Globals, ParseTreeModuleSrc,
        NoExportWarnSpecs),
    add_to_be_written_warn_specs(NoExportWarnSpecs, !MaybeWrittenSpecs),
    ...
    get_read_module_specs(BaggageErrors, BaggageErrSpecs, BaggageWarnSpecs),
...
process_augmented_module(ProgressStream, ErrorStream, Globals,
    ...
    ;
        ...
        OptBlockingErrors = contains_errors(Globals, coerce(OptBlockingSpecs)),
