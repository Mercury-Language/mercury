...
:- type ml_gen_tscc_info
    --->    ml_gen_tscc_info(
                mgti_func_label_counter     :: ucounter,
                mgti_label_counter          :: ucounter,
                mgti_aux_var_counter        :: ucounter,
                mgti_cond_var_counter       :: ucounter,
                mgti_conv_var_counter       :: ucounter,
                mgti_packed_word_counter    :: ucounter,
...
ml_gen_info_new_label(Label, !Info) :-
    ...
    counter.uallocate(Label, Counter0, Counter),
...
ml_gen_info_new_aux_func_id(MaybeAux, !Info) :-
    ...
    counter.uallocate(Num, Counter0, Counter),
...
ml_gen_info_bump_counters(!Info) :-
    ...
    counter.uallocate(FuncLabel, FuncLabelCounter0, _),
    FuncLabelCounter = counter.uinit(FuncLabel + 10000u),
...
ml_gen_info_new_aux_var_name(AuxVar, VarName, !Info) :-
    ...
    counter.uallocate(AuxVarNum, AuxVarCounter0, AuxVarCounter),
...
ml_gen_info_new_cond_var(cond_seq(CondNum), !Info) :-
    ...
    counter.uallocate(CondNum, CondCounter0, CondCounter),
...
ml_gen_info_new_conv_var(conv_seq(ConvNum), !Info) :-
    ...
    counter.uallocate(ConvNum, ConvCounter0, ConvCounter),
...
ml_gen_info_new_packed_word_var(LocalVarName, !Info) :-
    ...
    counter.uallocate(PackedWordNum, PackedWordCounter0, PackedWordCounter),
...
generate_tail_rec_start_label(TsccKind, Id) = Label :-
    ...
    ;
        ...
        Label = mlds_label(string.format("top_of_proc_%u", [u(IdNum)]))
    ).
...
/*  2 */        mgi_func_counter        :: ucounter,
/*  3 */        mgi_conv_var_counter    :: ucounter,
...
/*  2 */        mgsi_label_counter          :: ucounter,
/*  3 */        mgsi_aux_var_counter        :: ucounter,
/*  4 */        mgsi_cond_var_counter       :: ucounter,

/*  5 */        mgsi_packed_word_counter    :: ucounter,
...
init_ml_gen_tscc_info(ModuleInfo, InSccMap, TsccKind, TsccInfo) :-
    ...
    counter.uinit(1u, FuncLabelCounter),
    counter.uinit(0u, LabelCounter),
    counter.uinit(0u, AuxVarCounter),
    counter.uinit(0u, CondVarCounter),
    counter.uinit(0u, PackedWordCounter),
    counter.uinit(0u, ConvVarCounter),
...
:- pred ml_gen_info_get_func_counter(ml_gen_info::in, ucounter::out) is det.
:- pred ml_gen_info_get_conv_var_counter(ml_gen_info::in,
    ucounter::out) is det.
:- pred ml_gen_info_get_label_counter(ml_gen_info::in, ucounter::out) is det.
:- pred ml_gen_info_get_aux_var_counter(ml_gen_info::in, ucounter::out) is det.
:- pred ml_gen_info_get_cond_var_counter(ml_gen_info::in,
    ucounter::out) is det.
...
:- pred ml_gen_info_set_func_counter(ucounter::in,
    ml_gen_info::in, ml_gen_info::out) is det.
:- pred ml_gen_info_set_conv_var_counter(ucounter::in,
    ml_gen_info::in, ml_gen_info::out) is det.
:- pred ml_gen_info_set_closure_wrapper_defns(list(mlds_function_defn)::in,
    ml_gen_info::in, ml_gen_info::out) is det.
:- pred ml_gen_info_set_env_var_names(set(string)::in,
    ml_gen_info::in, ml_gen_info::out) is det.
:- pred ml_gen_info_set_label_counter(ucounter::in,
    ml_gen_info::in, ml_gen_info::out) is det.
:- pred ml_gen_info_set_aux_var_counter(ucounter::in,
    ml_gen_info::in, ml_gen_info::out) is det.
:- pred ml_gen_info_set_cond_var_counter(ucounter::in,
    ml_gen_info::in, ml_gen_info::out) is det.
:- pred ml_gen_info_set_packed_word_counter(ucounter::in,
    ml_gen_info::in, ml_gen_info::out) is det.
