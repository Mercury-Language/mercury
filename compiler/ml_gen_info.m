...
/* 10 */        mgri_const_struct_map   :: map(int, ml_ground_term),
                ...
                %
                % Writeable.
/* 11 */        mgri_var_lvals          :: map(prog_var, mlds_lval),

                % The set of used environment variables. Writeable.
/* 12 */        mgri_env_var_names      :: set(string),

                % The set of warnings disabled in the current scope. Writeable.
/* 13 */        mgri_disabled_warnings  :: set(goal_warning),

/* 14 */        % For each procedure to whose tail calls we can apply
