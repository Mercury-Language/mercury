...
encode_string_proc_label(ProcLabel, BytesCord) :-
    ...
    ;
        ...
        % XXX The long names generated by uci_pred_name, including the __s,
        % are wasted here. All we should need is a single byte, which is
        % one of 'u', 'c' or 'i', or an equivalent enum.
...
cons_id_rep(closure_cons(_)) = "$closure_cons".
