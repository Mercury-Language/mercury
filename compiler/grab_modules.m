...
:- type maybe_opt_file_error
    ...
    %
:- pred grab_plain_opt_and_int_for_opt_files(globals::in,
    maybe_opt_file_error::out, module_baggage::in, module_baggage::out,
...
process_module_int0_for_acu(Globals, ReadWhy0, ModuleName,
    ...
    (
        ...
        IntImportMap = ParseTreeInt0 ^ pti0_int_imports,
        IntUseMap = ParseTreeInt0 ^ pti0_int_uses,
        ImpImportMap = ParseTreeInt0 ^ pti0_imp_imports,
        ImpUseMap = ParseTreeInt0 ^ pti0_imp_uses,
