    ...
    ;
        ...
        (
            ...
            StdSetClauseInfo = item_clause_info(pf_predicate, StdSetPredName,
                ...
                Context, item_no_seq_num),
            module_add_clause(PredStatus, goal_type_none, StdGetClauseInfo,
                !ModuleInfo, !QualInfo, !Specs),
            module_add_clause(PredStatus, goal_type_none, StdSetClauseInfo,
                !ModuleInfo, !QualInfo, !Specs),
        ...
        ;
            ...
            module_add_clause(PredStatus, goal_type_none, IOGetClauseInfo,
                !ModuleInfo, !QualInfo, !Specs),
            module_add_clause(PredStatus, goal_type_none, IOSetClauseInfo,
                !ModuleInfo, !QualInfo, !Specs),
...
define_init_pred(ItemMutable, PredStatus, Lang, InitSetPredName,
    ...
    module_add_clause(PredStatus, goal_type_none, InitClauseInfo,
        !ModuleInfo, !QualInfo, !Specs),
