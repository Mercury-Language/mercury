...
construct_higher_order_terms(ModuleInfo, HeadVars0, HeadVars, ArgModes0,
	...
	list__map(lambda([ArgMode :: in, InstPair :: out] is det, (
		...
		)), CurriedArgModes1, CurriedArgModes2),
	mode_util__inst_pairs_to_uni_modes(CurriedArgModes2, CurriedArgModes2,
					UniModes),
	...
	instmap_delta_from_assoc_list([LVar - Inst], InstmapDelta),
