...
output_trans_opt_file(ProgressStream, ErrorStream, !.HLDS, !Specs,
    ...
    module_name_to_file_name(Globals, $pred, do_create_dirs,
        newext_opt(ext_opt_trans), ModuleName, OptFileName, !IO),
    ...
    ;
        ...
        touch_interface_datestamp(Globals, ProgressStream, ErrorStream,
            ModuleName, newext_opt(ext_opt_date_trans), _TouchSucceeded, !IO),
...
maybe_bytecodes(ProgressStream, HLDS0, Verbose, Stats, !DumpInfo, !IO) :-
    ...
    (
        ...
        module_name_to_file_name(Globals, $pred, do_create_dirs,
            newext_bytecode(ext_bc_bytedebug), ModuleName, BytedebugFile, !IO),
        maybe_write_string(ProgressStream, Verbose,
        ...
        maybe_write_string(ProgressStream, Verbose, " done.\n", !IO),
        module_name_to_file_name(Globals, $pred, do_create_dirs,
            newext_bytecode(ext_bc_mbc), ModuleName, BytecodeFile, !IO),
        maybe_write_string(ProgressStream, Verbose,
            "% Writing bytecodes to `", !IO),
