...
output_trans_opt_file(ProgressStream, ErrorStream, !.HLDS, !Specs,
    ...
    module_name_to_file_name_create_dirs(Globals, $pred,
        ext_opt(ext_opt_trans), ModuleName, OptFileName, !IO),
...
maybe_bytecodes(ProgressStream, HLDS0, Verbose, Stats, !DumpInfo, !IO) :-
    ...
    (
        ...
        module_name_to_file_name_create_dirs(Globals, $pred,
            ext_bytecode(ext_bc_bytedebug), ModuleName, BytedebugFile, !IO),
        maybe_write_string(ProgressStream, Verbose,
        ...
        maybe_write_string(ProgressStream, Verbose, " done.\n", !IO),
        module_name_to_file_name_create_dirs(Globals, $pred,
            ext_bytecode(ext_bc_mbc), ModuleName, BytecodeFile, !IO),
        maybe_write_string(ProgressStream, Verbose,
            "% Writing bytecodes to `", !IO),
