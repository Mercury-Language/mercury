...
output_trans_opt_file(ProgressStream, ErrorStream, !.HLDS, !Specs,
    ...
    ;
        ...
        touch_interface_datestamp(Globals, ProgressStream, ErrorStream,
            ModuleName, other_ext(".trans_opt_date"),
            newext_opt(ext_opt_date_trans), _TouchSucceeded, !IO),
...
maybe_bytecodes(ProgressStream, HLDS0, Verbose, Stats, !DumpInfo, !IO) :-
    ...
    (
        ...
        module_name_to_file_name(Globals, $pred, do_create_dirs,
            ext_other(other_ext(".bytedebug")),
            newext_bytecode(ext_bc_bytedebug),
        ...
        maybe_write_string(ProgressStream, Verbose, " done.\n", !IO),
        module_name_to_file_name(Globals, $pred, do_create_dirs,
            ext_other(other_ext(".mbc")), newext_bytecode(ext_bc_mbc),
