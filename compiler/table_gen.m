...
create_new_io_goal(OrigGoal, TableIoEntryKind, Unitize, TableIoStates,
    ...
    (
        ...
        make_const_construction_alloc(Context, TableIoEntryConsId,
            c_pointer_type, is_not_dummy_type, "TableIoEntryDescPtr",
            TableIoEntryDescGoal, TableIoEntryDescPtrVar, !VarTable),
...
keep_marker(marker_was_input_specialized) = yes.
...
generate_error_goal(TableInfo, Context, Msg, !VarTable, Goal) :-
    ...
    make_string_const_construction_alloc(Context, Message, "Message",
