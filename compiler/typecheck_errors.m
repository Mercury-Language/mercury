...
:- type actual_expected_types
    --->    actual_expected_types(
                ...
                actual_type_pieces      :: list(format_component),
                actual_type             :: mer_type,
                expected_type_piece     :: list(format_component),
...
:- func type_diff_pieces(list(format_component), list(tvar),
    mer_type, mer_type) = list(format_component).
...
type_diff_pieces(ContextPieces, ExistQTVars, ActualType0, ExpectedType0)
    ...
    % length mismatches.
    %
:- func arg_type_list_diff_pieces(list(format_component),
    list(format_component), list(tvar), list(mer_type), list(mer_type))
    = list(format_component).
...
:- func higher_order_diff_pieces(list(format_component), list(tvar),
    pred_or_func, pred_or_func, list(mer_type), list(mer_type),
    ho_inst_info, ho_inst_info, purity, purity) = list(format_component).
...
higher_order_diff_pieces(ContextPieces, ExistQTVars, ActualPorF, ExpectedPorF,
    ...
    %
:- func arg_type_list_diff_pieces_loop(list(format_component),
    list(format_component), list(tvar), int, list(mer_type), list(mer_type))
    = list(format_component).
...
:- func wrap_diff_pieces(list(format_component), list(format_component))
    = list(format_component).
