...
maybe_generate_warning_for_implicit_stream_predicate(ModuleInfo,
    ...
    then
        ...
        predicate_table_lookup_pf_sym_name_name_pfa(PredTable,
            is_fully_qualified, PredOrFunc, PredSymName, PredFormArityPlus1,
            PredIds),
        list.filter(
...
simplify_inline_builtin_inequality(TI, X, Y, Inequality, Invert, GoalInfo,
    ...
    DuCtor = du_ctor(qualified(BuiltinModule, Inequality), 0, TypeCtor),
...
simplify_make_binary_op_goal_expr(Info, ModuleName, Op, IsBuiltin, X, Y, Z,
    ...
    simplify_info_get_module_info(Info, ModuleInfo),
    module_info_get_predicate_table(ModuleInfo, PredTable),
    predicate_table_lookup_func_sym_name_name_user_arity_one(PredTable,
        is_fully_qualified, OpSymName, user_arity(2), OpPredId),
