...
unique_modes__check_par_conj_0(NonLocalVarsBag, ModeInfo0, ModeInfo) :-
	...
	mode_info_get_module_info(ModeInfo0, ModuleInfo0),
	make_shared_inst_list(VarInsts, InstTable0, ModuleInfo0, InstMap0,
		SharedVarInsts, InstTable1, ModuleInfo1, InstMap1),
	mode_info_set_module_info(ModeInfo0, ModuleInfo1, ModeInfo1),
	instmap__set_vars(InstMap1, SharedList, SharedVarInsts, InstMap),
	mode_info_set_instmap(InstMap, ModeInfo1, ModeInfo2),
	mode_info_set_inst_table(InstTable1, ModeInfo2, ModeInfo).
