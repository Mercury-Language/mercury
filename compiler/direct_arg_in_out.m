...
make_direct_arg_in_out_clone(ProgressStream, PredProcId, OoMInOutArgs,
    ...
    proc_prepare_to_clone(ProcInfo, HeadVars, Goal, VarTable,
        ...
        _DetismDecl, _CseNopullContexts, MaybeUntupleInfo, MaybeInputSpecProc,
        VarNameRemap, _StateVarWarnings, DeletedCallees, IsAddressTaken,
        ...
        MaybeMMTablingInfo, SharingReuseInfo),
    ...
    proc_create(CloneHeadVars, Goal, CloneVarTable,
        ...
        MaybeUntupleInfo, MaybeInputSpecProc, VarNameRemap,
        CloneStateVarWarnings, DeletedCallees,
        IsAddressTaken, HasForeignProcExports, HasParallelConj,
    ...
    ;
        ...
        then
            ...
            CopySymName = qualified(mercury_private_builtin_module,
                "partial_inst_copy"),
            predicate_table_lookup_pred_sym_name_name_user_arity_one(PredTable,
