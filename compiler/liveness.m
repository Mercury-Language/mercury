...
detect_liveness_in_goal_2(switch(Var, Cases0), Liveness0,
				ModuleInfo, Liveness, switch(Var, Cases)) :-
	set__init(Union0),
...
detect_deadness_in_goal_2(switch(Var, Cases0), Deadness0,
				ModuleInfo, Deadness, switch(Var, Cases)) :-
	set__init(Union0),
