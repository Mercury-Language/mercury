...
maybe_read_d_file_for_trans_opt_deps(ProgressStream, ErrorStream, Globals,
    ...
    (
        ...
        module_name_to_file_name(Globals, $pred,
            ext_mmake_fragment(ext_mf_d), ModuleName, DependencyFileName),
        (
            Verbose = yes,
        ...
        (
            ...
            module_name_to_file_name(Globals, $pred,
                ext_opt(ext_opt_date_trans), ModuleName, TransOptDateFileName),
...
maybe_write_definitions(ProgressStream, ErrorStream, Verbose, Stats,
    ...
    (
        ...
        module_name_to_file_name_create_dirs(Globals, $pred,
            ext_user_ngs(ext_user_ngs_defns), ModuleName, FileName, !IO),
...
maybe_write_definition_line_counts(ProgressStream, ErrorStream, Verbose, Stats,
    ...
    (
        ...
        module_info_get_name(HLDS, ModuleName),
        module_name_to_file_name_create_dirs(Globals, $pred,
            ext_user_ngs(ext_user_ngs_defn_lc), ModuleName, FileName, !IO),
        io.open_output(FileName, Res, !IO),
        (
            Res = ok(FileStream),
...
maybe_write_definition_extents(ProgressStream, ErrorStream, Verbose, Stats,
    ...
    (
        ...
        module_info_get_name(HLDS, ModuleName),
        module_name_to_file_name_create_dirs(Globals, $pred,
            ext_user_ngs(ext_user_ngs_defn_ext), ModuleName, FileName, !IO),
        io.open_output(FileName, Res, !IO),
        (
            Res = ok(FileStream),
