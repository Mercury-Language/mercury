...
make_hlds(ProgressStream, ErrorStream, Globals, AugCompUnit, EventSet, MQInfo,
    ...
    module_name_to_file_name(Globals, $pred, do_create_dirs,
        ext_other(other_ext(".hlds_dump")), newext_user(ext_user_hlds_dump),
...
maybe_write_definitions(ProgressStream, ErrorStream, Verbose, Stats,
    ...
    (
        ...
        module_name_to_file_name(Globals, $pred, do_create_dirs,
            ext_other(other_ext(".defns")),
            newext_user_ngs(ext_user_ngs_defns), ModuleName, FileName, !IO),
...
maybe_write_definition_line_counts(ProgressStream, ErrorStream, Verbose, Stats,
    ...
    (
        ...
        module_name_to_file_name(Globals, $pred, do_create_dirs,
            ...
            newext_user_ngs(ext_user_ngs_defn_lc), ModuleName, FileName, !IO),
        io.open_output(FileName, Res, !IO),
        (
            Res = ok(FileStream),
...
maybe_write_definition_extents(ProgressStream, ErrorStream, Verbose, Stats,
    ...
    (
        ...
        module_info_get_name(HLDS, ModuleName),
        module_name_to_file_name(Globals, $pred, do_create_dirs,
            ext_other(other_ext(".defn_extents")),
            newext_user_ngs(ext_user_ngs_defn_ext), ModuleName, FileName, !IO),
        io.open_output(FileName, Res, !IO),
        (
            Res = ok(FileStream),
