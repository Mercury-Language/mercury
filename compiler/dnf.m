...
% database type transformation algorithms, and is also helpful when one wants
% to produce Prolog code with good performance.
...
dnf__transform_goal(Goal0, InstMap0, MaybeNonAtomic, !ModuleInfo,
    ...
    ;
        ...
        sorry(this_file, "dnf of parallel conjunction not implemented")
    ;
    ...
    ;
        ...
        unexpected(this_file, "transform_goal: unexpected shorthand")
    ).
...
dnf__make_goal_literal(Goal0, InstMap0, MaybeNonAtomic, !ModuleInfo,
    ...
    ;
        ...
        dnf__get_new_pred_name(PredTable0, OrigPredName, Name, Num, !Counter),
