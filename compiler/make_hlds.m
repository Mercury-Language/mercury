...
add_item_decl_pass_1(Item, Context, !Status, !ModuleInfo, InvalidMode, !IO) :-
    Item = inst_defn(OldSyntax, VarSet, Name, Params, InstDefn, Cond),
    (
        OldSyntax = yes,
...
add_item_decl_pass_1(Item, Context, !Status, !ModuleInfo, InvalidMode, !IO) :-
    Item = mode_defn(OldSyntax, VarSet, Name, Params, ModeDefn, Cond),
    (
        OldSyntax = yes,
...
add_item_decl_pass_2(Item, _, !Status, !ModuleInfo, !IO) :-
    Item = inst_defn(_, _, _, _, _, _).
add_item_decl_pass_2(Item, _, !Status, !ModuleInfo, !IO) :-
    Item = mode_defn(_, _, _, _, _, _).
add_item_decl_pass_2(Item, _, !Status, !ModuleInfo, !IO) :-
