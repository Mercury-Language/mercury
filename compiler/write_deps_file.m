...
generate_d_file(Globals, BurdenedAugCompUnit, IntermodDeps,
    ...
    make_module_file_name(Globals, $pred,
        ext_cur_ngs_gs(ext_cur_ngs_gs_obj_pic_o),
...
generate_dep_file(Globals, SourceFileName, ModuleName, DepsMap,
    ...
    module_name_to_file_name_create_dirs(Globals, $pred,
        ext_cur_ngs_gs(ext_cur_ngs_gs_init_obj_dollar_o),
        ModuleName, InitObjFileName, !IO),
    module_name_to_file_name_create_dirs(Globals, $pred,
        ext_cur_ngs_gs(ext_cur_ngs_gs_init_obj_pic_o),
...
generate_dep_file_exec_library_targets(Globals, ModuleName,
    ...
    module_name_to_file_name(Globals, $pred,
        ext_cur_gs(ext_cur_gs_exec_noext), ModuleName, ExeFileName),
    ...
    module_name_to_lib_file_name_create_dirs(Globals, $pred, "lib",
        ext_cur_gs(ext_cur_gs_exec_noext), ModuleName, LibTargetName, !IO),
