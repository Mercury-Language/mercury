...
:- type global_object_counter ---> global_object_counter.
...
:- pred do_op(operator, env, stack, stack, io__state, io__state).
...
:- pred renameObject(object::in, object::out, io__state::di,
		io__state::uo) is det.
...
:- pred next_object_id(object_id::out, io__state::di, io__state::uo) is det.

next_object_id(Id) -->
	get(global_object_counter, Id),
	set(global_object_counter, Id + 1).
...
:- pred do_extra(extra_operator, env, stack, stack, io__state, io__state).
...
:- pred do_extra2(extra_operator, env, stack, stack, io__state, io__state).
